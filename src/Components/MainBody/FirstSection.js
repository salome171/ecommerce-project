...
const FirstSection = () => {
  return (
    <div className='Headerstylecontainerall mx-auto grid grid-cols -mt-[10%]  xl:-mt-[20%]
    lgl:grid-cols-2 xl:grid-cols-4 gap-4 mdl:gap-6 px-auto place-items-center max-w-screen-2xl'
    >
